"""
	List of functions to manage actions (Create, Read, Update, Delete) of `Latency` data
"""
...
def get_data_by_section(db_model, section):
	try:
		# data = db_model.objects(section=section).only("latency").to_json()
		data = db_model.objects(section=section).to_json()
	except Exception as e:
		return False, None
