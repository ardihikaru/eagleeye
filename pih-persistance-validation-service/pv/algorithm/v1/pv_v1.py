...
class PVv1:
    def __init__(self):
        ...
        self.pih_label_cand = asab.Config["bbox_config"]["pih_label_cand"]
        ...
        # Sef default value
        self.total_pih_candidates = None
        self.period_pih_candidates = None
        self.cur_frame_id = None

    def initialize(self, cur_frame_id, total_pih_candidates, period_pih_candidates):
    ...
    def __get_tolerance_limit(self):
        tolerance_percentage = float(asab.Config["persistence_detection"]["tolerance_limit_percentage"])
