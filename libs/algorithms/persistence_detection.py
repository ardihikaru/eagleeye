...
# class PersistenceDetection(MyRedis):
    def __init__(self, opt, cur_frame_id, total_pih_candidates, period_pih_candidates):
        ...
        self.tolerance_limit = common_settings["persistence_detection"]["tolerance_limit"]
    ...
    def persistence_module(self, check_batch):
        ...
        # Get end_frame_id
        end_frame_id = check_batch[self.persistence_window - 1]
