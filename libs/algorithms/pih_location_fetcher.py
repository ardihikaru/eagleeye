...
class PIHLocationFetcher(MyRedis):
    ...
    # def __plot_fps_info(self, img_width, drone_id, frame_id, rc_latency, img):
    ...
    #     t0 = redis_get(rc_latency, t_start_key)
    #     # t1 = time.time()
    #     t1 = time.time()
    #     t_elapsed = t1 - t0
    ...
    #     redis_set(rc_latency, fps_visualizer_key, visualizer_fps)
    #
    ...
    #
    # def __plot_gps_info(self, img_height, gps_data, det_status, img):
