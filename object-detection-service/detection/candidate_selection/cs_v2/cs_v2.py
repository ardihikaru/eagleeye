...
# import time
from detection.candidate_selection.cs_v2.region_cluster import RegionCluster
...
class CSv2(RegionCluster):
    ...
    # def __init__(self, cam, source_img, save_path, det, img, names):
    # def __init__(self, source_img, save_path, det, img, names):
    # def __init__(self, save_path, det, img, names):
    # def __init__(self, det, img, names):
    # def __init__(self, det, names, height=1920, width=1080, channels=3):
    # def __init__(self, det, names, height=1920, width=1080, channels=3):
    def __init__(self):
        super().__init__()
        # self.cam = cam
